...
class DataProcessor(object):
    def __init__(self, i_min: float, i_max: float, mean: float, std: float, 
                 output_dir: str, 
                 model_type: str,
...
def main(args):
    ...
    dp = DataProcessor(i_min=-54.0, i_max=258.0, mean=100.0, std=50.0, 
                       output_dir=args.output, 
                       output_postfix=args.client_name,
...
if __name__ == "__main__":
    ...
    parser.add_argument("--client_name", "-c", type=str, help="Client name.")
